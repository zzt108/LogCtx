...
New MS Extensions Logging and NLog specific code with documentation can be found in the branch [`nlog-native`](https://github.com/zzt108/LogCtx/blob/nlog-native/README.md)
